...
Clone this repo by copying https://github.com/Alejandro-Bernal-M/school_library.git
and run it .
...
interacting on the console with other functionalities
...
Feel free to check [issues page](https://github.com/Alejandro-Bernal-M/school_library/issues).
